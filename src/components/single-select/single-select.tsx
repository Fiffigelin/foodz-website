...
//   value: string;
//   onChange: (value: SingleSelectItem) => void;
// };
...
//       {open && (
//         <ul className="absolute z-20 mt-1 w-full rounded bg-gray-50 ring-1 ring-gray-300">
//           {items.map((item) => {
//             const isSelected = value === item.name;
//             return (
//               <li
//                 key={item.id}
//                 className={`cursor-pointer select-none p-2 hover:bg-gray-200 ${isSelected ? "bg-green-100" : ""}`}
//                 onClick={() => select(item)}
//               >
//                 {item.name}
//               </li>
