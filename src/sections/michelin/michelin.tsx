...
function Michelin() {
  return (
    ...
    h-full mt-20 items-center">
      <div className="flex w-3/5 md:w-[60%] justify-evenly">
        <TextHeader text={"19"} />
      ...
      <div className="flex justify-between h-full">
        ...
        <div className="flex flex-col w-full h-full text-justify md:w-1/2 px-2 lg:w-1/2 lg:px-6">
          <div className="flex justify-start md:justify-between text-(--color-green) font-semibold my-3">
            <h2 className="text-xl md:text-md xl:text-xl">Alain Ducasse - 19 Michelin Stars</h2>
